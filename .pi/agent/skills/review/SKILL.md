---
name: review
description: Use for strict code-quality review of local changes, commits/ranges, or GitHub PRs; also for review-oriented subagents/checkpoints in orchestrated coding work.
---
